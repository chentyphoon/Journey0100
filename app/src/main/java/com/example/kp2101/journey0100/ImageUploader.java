...
public class ImageUploader {
    ...
    public void uploadFile(String id, FileInputStream inputImage) {
        String end = "\r\n";
        String twoHyphens = "--";
        String boundary = "*****";
        try
        {
          ...
          /* 设置DataOutputStream，getOutputStream中默认调用connect()*/
            ...
            ds.writeBytes("Content-Disposition: form-data; " +
                    "name=\"file\";filename=\""+fileName+id+".jpg\"" + end);
            ds.writeBytes(end);

          /* 取得文件的FileInputStream */
            FileInputStream fStream = inputImage;
          /* 设置每次写入8192bytes */
            int bufferSize = 8192;
          ...
          /* 从返回的输入流读取响应信息 */
            ...
            con.disconnect();
          /* 显示网页响应内容 */
            //text1.setText(b.toString().trim());
            Log.d("eroroerororo", b.toString().trim());//Post成功
        } catch (Exception e)
        {
            /* 显示异常信息 */
            //Toast.makeText(MainActivity.this, "Fail:" + e, Toast.LENGTH_SHORT).show();//Post失败
            //text1.setText("Fail:" + e);
        }
    }
