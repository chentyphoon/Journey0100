...
public class PlaceAdapter extends BaseAdapter{
    ...
    private List<Myplace> consumes;
    private LayoutInflater inflater;
    private ImageLoadingListener animateFirstListener = new AnimateFirstDisplayListener();
    private DisplayImageOptions options;
    //private int resource;

    public PlaceAdapter(Context context, List<Consume> consumes) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        com.nostra13.universalimageloader.core.ImageLoader.getInstance().displayImage(consume.getcPic(), holder.ivcPic, options, animateFirstListener);
